...
export default function AdminCerebro() {
  ...
  return (
    <Routes>
      ...
      <Route path="contable"      element={<ContableController />} />
      <Route path="caja"          element={<CajaResumenController professionals={professionals} />} />
      <Route path="equipo"        element={<EquipoAdmin />} />
      <Route path="rrhh"          element={<RRHHController />} />
      <Route path="informes"      element={<div className="agenda-placeholder">Informes clínicos — próximamente</div>} />
      <Route path="configuracion" element={<div className="agenda-placeholder">Configuración del sistema — próximamente</div>} />
    </Routes>
  );
}
